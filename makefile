...
clock-test:
	...
	iverilog -g2012  -o test/clock_test/clock_gen.vvp  test/clock_test/clock_gen_tb.sv src/clock_gen.v src/clock_sample.v msrc/clock_sar.v 
...
OPENLANE_DIR ?=/home/unixpoly/vlsi/tools/OpenLane

DOCKER_OPTIONS = $(shell $(PYTHON_BIN) $(OPENLANE_DIR)/env.py docker-config)

DOCKER_ARCH ?= $(shell $(PYTHON_BIN) $(OPENLANE_DIR)/docker/current_platform.py)
...
include $(OPENLANE_DIR)/dependencies/image_name.mk
